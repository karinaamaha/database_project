...
<head>
    ...
    <title>Penghuni | Tambah Data</title>
</head>
<body>
    <header>
       <div class="left_area">
    ...
    <form action="controller/cek_tambah_data.php" method="POST" id="tambah">
        ...
        <table width="80%" id="tambah" border="0">
            ...
            <tr>
                ...
                <td><input type="text" name="no_kos" id="no_kos" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="harga">Total Harga</label></td>
