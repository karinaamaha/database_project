...
<head>
    ...
    <title>Layanan | Tambah Layanan</title>
</head>
<body>
    <header>
       <div class="left_area">
    ...
    <div class="content">
    <form action="controller/cek_tambah_layanan.php" method="POST" id="tambah">
        <h1>Tambah Layanan </h1>
        <table width="80%" id="tambah" border="0">
            <tr>
                <td><label for="nama_layanan">Nama Layanan</label></td>
                <td ><input type="text" name="nama_layanan" id="nama_layanan" required></td>
            </tr>
            <tr>
                <td><label for="harga_layanan">Harga Layanan</label></td>
                <td ><input type="text" name="harga_layanan" id="harga_layanan" required></td>
            </tr>
        </table>
