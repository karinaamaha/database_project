...
<head>
    ...
    <title>Tagihan | Tambah Tagihan</title>
</head>
<body>
    <header>
       <div class="left_area">
    ...
    <div class="content">
    <form action="controller/cek_tambah_tagihan.php" method="POST" id="tambah">
        ...
        <tr>
            ...
            <tr>
                <td><label for="keterangan">Keterangan Tagihan</label></td>
                <td><select name="keterangan" id="keterangan">
                    <option value="">--- pilih keterangan tagihan ---</option>
            ...
            <tr>
                <td><label for="jlh_tagihan">Total Tagihan</label></td>
                <td><input type="text" name="jlh_tagihan" id="jlh_tagihan" required></td>
            </tr>
         
    
        </table>

        <center><button type="submit" name="tambah">Buat Tagihan</button></center>
