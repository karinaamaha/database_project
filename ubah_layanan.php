...
$layanan = query("SELECT * FROM info_layanan WHERE nama_layanan = '$nama_layanan'")[0];
...
<head>
    ...
    <title>Layanan | Ubah Layanan</title>
</head>
<body>
    <header>
       <div class="left_area">
    ...
    <div class="content">
    <form action="controller/cek_ubah_layanan.php" method="POST" id="tambah">
        <h1>Ubah Layanan </h1>
        <table width="80%" id="tambah" border="0">
        <input type="hidden" name="nama_layanan" id="nama_layanan" value="<?php echo $layanan["nama_layanan"]; ?>">
            <tr>
                <td><label for="nama_layanan">Nama Layanan</label></td>
                <td ><input type="text" name="nama_layanan" id="nama_layanan" disabled value="<?php echo $layanan["nama_layanan"] ?>"></td>
            </tr>

        
            <tr>
                <td><label for="harga_layanan">Harga Layanan</label></td>
                <td ><input type="text" name="harga_layanan" id="harga_layanan" required value="<?php echo $layanan["harga_layanan"] ?>"></td>
            </tr>
