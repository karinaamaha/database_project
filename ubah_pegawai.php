...
<head>
    ...
    <title>Pegawai | Ubah Pegawai</title>
</head>
<body>
    <header>
       <div class="left_area">
    ...
    <div class="content">
    <form action="controller/cek_ubah_pegawai.php" method="POST" id="tambah">
        <h1>Ubah Pegawai</h1>
        <table width="80%" id="tambah" border="0">
            ...
            <input type="hidden" name="id_pegawai" id="id_pegawai" value="<?php echo $pegawai["id_pegawai"]; ?>">
                ...
                <td ><input type="text" name="nama_pegawai" id="nama_pegawai" required value="<?php echo $pegawai["nama_pegawai"] ?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td ><select name="jenis_kelamin" id="jenis_kelamin">
                    ...
                    <?php 
                      echo '<option value="'.$pegawai['jenis_kelamin'].'">'.$pegawai['jenis_kelamin'].' </option>';
                    ?>
            ...
            <tr>
                ...
                <td ><input type="text" name="no_hp" id="no_hp" required value="<?php echo $pegawai["no_hp"] ?>"></td>
            </tr>
            <tr>
                <td><label for="alamat">Alamat Lengkap</label></td>
                <td ><input type="text" name="alamat" id="alamat" required value="<?php echo $pegawai["alamat_pegawai"] ?>"></td>
            </tr>
            <tr>
                <td><label for="gaji">Gaji</label></td>
                <td ><input type="text" name="gaji" id="gaji" required value="<?php echo $pegawai["gaji"] ?>"></td>
            </tr>
